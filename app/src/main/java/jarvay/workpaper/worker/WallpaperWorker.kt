...
class WallpaperWorker @AssistedInject constructor(
    ...
    private suspend fun setVideoWallpaper(wallpaper: Wallpaper): Boolean {
        val currentContentUri = runningPreferencesRepository.runningPreferencesFlow.first().currentVideoContentUri
